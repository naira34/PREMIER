...
$nom_personne = $prenom = $email = $direction = $departement = $atelier = $structure = $fonction = $password = $role = "";
$nom_personne_err = $prenom_err = $email_err = $atelier_err = $structure_err = $fonction_err = "";
...
if(isset($_POST["id_personne"]) && !empty($_POST["id_personne"])){
    ...
    if(empty($input_atelier)){
        $atelier_err = "Please enter an atelier.";     
    } else{
    ...
    if(empty($input_fonction)){
        $fonction_err = "Please enter an structure.";     
    } else{
    ...
    if(empty($nom_personne_err) && empty($prenom_err) && empty($email_err) && empty($atelier_err) && empty($structure_err) && empty($fonction_err)){
        // Prepare an update statement

        $sql = "UPDATE personne SET  nom_personne=?, prenom=?, email=?, direction=?, departement=?, atelier=?, structure=?, fonction=?, password=?, role=? WHERE id_personne=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssssssssi", $param_nom_personne, $param_prenom, $param_email, $param_direction, $param_departement, $param_atelier,  $param_structure, $param_fonction,$param_password, $param_role, $param_id_personne);
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                header("location: userliste.php?update=1");
                exit();
            } else{
    ...
    if(isset($_GET["id_personne"]) && !empty(trim($_GET["id_personne"]))){
        // Get URL parameter
        $id_personne=  trim($_GET["id_personne"]);
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            ...
                            <li><a title="All users" href="userliste.php"style="background-color:rgba(94, 92, 92, 0.043); color:rgb(79, 79, 79);"><span class="mini-sub-pro">La liste des utilisateurs</span></a></li>
                                <li><a title="Add user" href="add-user.php" ><span class="mini-sub-pro">Ajouter utilisateur</span></a></li>
                            </ul>
</li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="admin.php"><img class="main-logo" src="img/logo/logo.png"style="width: 100px;"alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li>
                                                        <a href="logout.php"><span class="edu-icon edu-locked author-log-ic">Déconnexion</span></a>                                                        </li>
                                                    </ul>
                                                </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Etudes <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="admin.php">Dashboard v.1</a></li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Demande d'info<span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="admin.php">Liste des demandes</a></li>
                            ...
                            <div class="breadcome-list single-page-breadcome">
                                <div class="row">
                                        ...
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Modifier utilisateur</span>
                                            </li>
                                        </ul>
                                </div>
                            </div>
        ...
        <div class="single-pro-review-area mt-t-30 mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Modifier employe</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <form  id="add-department"  class="add-department" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" >
                    ...
                    <div class="row">
                     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nom_personne" class="form-control" <?php echo (!empty($nom_personne_err)) ? 'is-invalid' : ''; ?> value="<?php echo $nom_personne; ?>">
                        ...
                        <div class="form-group">
                         <label>Direction</label>
                            ...
                            <option value="<?php echo $direction; ?>" selected=""><?php echo $direction; ?></option>
                        ...
                        <div class="form-group">
                           <label>Departement</label>
                            ...
                            <option value="<?php echo $departement; ?>" selected=""><?php echo $departement; ?></option>                                                                    
                            </select>
                    ...
                    <div class="form-group">
                            <label>atelier</label>
                            <input type="text" name="atelier" class="form-control" <?php echo (!empty($atelier_err)) ? 'is-invalid' : ''; ?> value="<?php echo $atelier; ?>">
                            <span class="invalid-feedback"><?php echo $atelier_err;?></span>
                        </div>
                        <div class="form-group">
                            <label>structure</label>
                            <input type="text" name="structure" class="form-control" <?php echo (!empty($structure_err)) ? 'is-invalid' : ''; ?> value="<?php echo $structure; ?>">
                            <span class="invalid-feedback"><?php echo $structure_err;?></span>
                        </div>
                        <div class="form-group">
                            <label>fonction</label>
                            <input type="text" name="fonction" class="form-control" <?php echo (!empty($fonction_err)) ? 'is-invalid' : ''; ?> value="<?php echo $fonction; ?>">
                    ...
                    <div class="col-lg-12">
                        <div class="payment-adress">
                          <input type="hidden" name="id" value="<?php echo $id_personne; ?>"/>
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#exampleModalCenter">Modifier employe</button>
                        </div>
                    </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Modifeir employé</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      Voulez-vous vraiment modifier un employé ?
      </div>
