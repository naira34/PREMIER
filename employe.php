...
$query = "SELECT * FROM personne WHERE username='$username' AND role='employee'";
$result = mysqli_query($link, $query);

if ($result) {
    $row = mysqli_fetch_assoc($result);

    // Utilisez les données récupérées dans la variable $row selon vos besoins
} else {
                    ...
                    <ul class="metismenu" id="menu1">
                       ...
                       <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Peity Charts" href="liste_demande.php"><span class="mini-sub-pro">Liste des demandes </span></a></li>
                                <li><a title="Peity Charts" href="add-demande.php"><span class="mini-sub-pro">ajouter une demandes </span></a></li>
                            </ul>
                        </li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                        ...
                                                        <?php echo $_SESSION["employe"]?></span>
