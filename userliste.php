    ...
    <div class="all-content-wrapper">
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Les etudes <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="la_liste_etude.html">Liste des etudes</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Users <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                            <li><a href="userliste.php" >Liste utilisateurs</a></li>
                                            <li><a href="add-user.php">Ajouter utilisateur</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Demande d'info <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="la_liste_demande.html">Liste des demandes</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </nav>
                            ...
                            <div class="breadcome-list single-page-breadcome">
                                <div class="row">
                                        ...
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">La liste des utilisateurs</span>
                                            </li>
                                        </ul>
        ...
        <div class="data-table-area mg-b-15">
            ...
            <span aria-hidden="true">&times;</span>
                        ...
                        <strong>Suppression!</strong> l\'utilisateur a été suppriméé.
                    </div>';
                    }?>
                            <?php
            ...
            <span aria-hidden="true">&times;</span>
                        ...
                        <strong>Update!</strong> L\'utilisateur a été mettre a jour avec succés.
                    </div>';
                    } 
            ...
            <span aria-hidden="true">&times;</span>
                        ...
                        <strong>Success!</strong> L\'utilisateur a été ajouter avec succés.
                    </div>';
                    } 
                    ...
                    ?>
                            <div class="add-product">
                                ...
                                <a href="add-user.php">Ajouter utilisateur</a>
                            </div>
                        </div>
                                            ...
                                            data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">';
                                                ...
                                                while($row = mysqli_fetch_array($result)){
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>";
                                                            echo '<a href="read-user.php?id_personne='. $row['id_personne'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a> &nbsp';
                                                            echo '<a href="update-user.php?id_personne='. $row['id_personne'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a> &nbsp';
                                                            echo '<a href="delete.php?id_personne='. $row['id_personne'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
                                                echo "</tbody>";                            
