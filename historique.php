                    ...
                    <ul class="metismenu" id="menu1">
                            <li>
                                ...
                                <ul class="submenu-angle" aria-expanded="false">
                                    <li><a title="All etude" href="la_liste_etude2.html"><span class="mini-sub-pro">Liste des etudes</span></a></li>
                                </ul>
                            </li>
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="All demandes" href="liste de dmande2.html"><span class="mini-sub-pro">Liste des demandes </span></a></li>
                                <li><a title="All demandes" href="liste de dmande2.html"><span class="mini-sub-pro">hisorique de demandes </span></a></li>
                            </ul>
                        </li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name">Chef departement</span>
        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM demmandeinfo WHERE  valid IS Not NULL";
                                    ...
                                    echo '<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        echo '<thead>';
                                            ...
                                            echo'<th data-field="state" data-checkbox="true"></th>';
                                                 echo'<th data-field="demandeur" >Demandeur</th>';
                                                 echo'<th data-field="titre">Titre</th>';
                                                 echo'<th data-field="date" >Direction</th>';
                                                 echo'<th data-field="date" >Departement</th>';
                                                 echo'<th data-field="date" >Atelier</th>';
                                                 echo'<th data-field="date" >Documment ecrit</th>';
                                                 echo'<th data-field="date" >Documment cartographie</th>';
                                                 echo'<th data-field="date" >Raster</th>';
                                                 echo'<th data-field="date" >Echelle</th>';
                                                 echo'<th data-field="date" >Date</th>';
                                                 echo'<th data-field="date" >Validation</th>';
