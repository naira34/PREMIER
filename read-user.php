...
// Check existence of id_personne parameter before processing further
if(isset($_GET["id_personne"]) && !empty(trim($_GET["id_personne"]))){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        // Set parameters
        $param_id_personne = trim($_GET["id_personne"]);
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) == 1){
                ...
                // URL doesn't contain valid id_personne parameter. Redirect to error page
    ...
    // URL doesn't contain id_personne parameter. Redirect to error page
    header("location: error.php");
    exit();
}
?>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <a href="logout.php"><span class="edu-icon edu-locked author-log-ic">Déconnexion</span></a></li>                                                        </li>
                                                    </ul>
                                                </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Details employe</a></li>
