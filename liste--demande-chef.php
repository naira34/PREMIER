        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    ...
                    $sql = "SELECT * FROM demmandeinfo WHERE  valid IS NULL";
                                    ...
                                    echo '<table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        echo '<thead>';
                                         ...
                                         while($row = mysqli_fetch_array($result)){
                                            ...
                                            echo "<td>" . $row['date'] . "</td>";
                                            echo "<td>";
                                            echo '<a href="detail-demande.php?iddemande='. $row['iddemande'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
