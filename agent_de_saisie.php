    ...
    <div class="all-content-wrapper">
        ...
        <div class="data-table-area mg-b-15">
            ...
            <span aria-hidden="true">&times;</span>
                        ...
                        <strong>Suppression!</strong> l\'étude a été suppriméé.
                    </div>';
                    }?>
                            <?php
            ...
            <span aria-hidden="true">&times;</span>
                        ...
                        <strong>Update!</strong> L\'étude a été mettre a jour avec succés.
                    </div>';
                    } 
            ...
            <span aria-hidden="true">&times;</span>
                        ...
                        <strong>Success!</strong> L\'etude a été ajouter avec succés.
                    </div>';
                    } 
                                    ...
                                    if($result = mysqli_query($link, $sql)){
                                        ...
                                        while($row = mysqli_fetch_array($result)){
                                            echo "<tr>";
                                                ...
                                                echo "<td>";echo '<a href="viewfolder.php?id_etude='. $row['id_etude'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><i class="far fa-folder-open folder-icon"></i></a> &nbsp';"</td>"; 
                                                echo "<td>";
                                               
                                                echo '<a href="read-etude.php?id_etude='. $row['id_etude'] .'" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a> &nbsp';
                                                ...
                                                echo '<a href="deleteetude.php?id_etude='. $row['id_etude'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                                echo "</td>";
                                                  echo "</tr>";
                                                }
                                                echo "</tbody>";                            
