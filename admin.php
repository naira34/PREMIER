                    ...
                    <ul class="metismenu" id="menu1">
                            <li class="active">
                                ...
                                <ul class="submenu-angle" aria-expanded="true">
                                    <li><a title="All etude" href="admin.php" style="background-color:rgba(94, 92, 92, 0.043); color:rgb(79, 79, 79);"><span class="mini-sub-pro">Liste des etudes</span></a></li>
                                </ul>
                            </li>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12" >
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="acceuil.html" class="nav-link">Home</a>
                                                </li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li>
                                                        <a href="logout.php"><span class="edu-icon edu-locked author-log-ic">Déconnexion</span></a>  
                                                                                                            </li>
                                                    </ul>
                                                </li>
